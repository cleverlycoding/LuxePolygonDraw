...
using ledoux.UtilityBelt.DynamicExtender;
...
class DynamicExtender {
	static public function jsonToScene(data:Dynamic, ?batcher:Batcher, ?scene:Scene, ?depthStart:Float, ?depthIncrement:Float) : Array<Polygon> {
